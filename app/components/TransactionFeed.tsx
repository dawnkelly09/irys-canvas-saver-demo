...
const currencies: OptionType[] = [{ value: "base-eth", label: "ETH on Base" }];
...
export const TransactionFeed: React.FC = () => {
	...
	const [selectedToken, setSelectedToken] = useState<OptionType | null>(currencies[0]);
	...
	return (
		<div className="bg-white border rounded-lg shadow-2xl p-5 w-700 h-700">
			<div className="flex flex-row">
				<div className="space-y-4 self-end text-black">
					...
					<div className="flex">
						<button
							className="text-white w-full justify-center text-md flex items-center gap-2 rounded-full px-4 py-3 font-robotoMono uppercase hover:font-bold lg:px-6 lg:py-5 bg-black"
							onClick={handleQuery}
				...
				{queryResults && queryResults.length > 0 && (
					<div className="ml-5 h-[320px] w-[340px] overflow-y-auto rounded-lg align-start">
						{
